...
@section('content')
    <div class="main-card mb-3 card">
        <div class="card-body">
            <h5 class="card-title">Nouveau Coulis</h5>
            {!! Form::open([
                'method' => 'POST',
                'url' => route('admin.boxes.store')
            ]) !!}
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" name="price" class="form-control" id="validationCustom05" placeholder="5000" required="">
                    </div>

                    <div class="col-md-4 mb-3">
                        <label for="validationCustom05">Note</label>
                        <input type="text" name="note" class="form-control" id="validationCustom05" placeholder="entrer une remarque">
                    </div>
                </div>
